...
public class LoaderManagerEx implements LoaderManager.LoaderCallbacks<String>{
    Context context;
    EditText mBookInput;
    TextView mTitleText;
    TextView mAuthorText;

    LoaderManagerEx(Context context, EditText mBookInput, TextView mTitleText, TextView mAuthorText) {
